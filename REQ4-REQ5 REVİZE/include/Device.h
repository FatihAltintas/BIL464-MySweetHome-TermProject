...
protected:
    string name;
    int id;
    DeviceState state; // isActive yerine state kullanýyoruz

    // REQ9: Bizi dinleyen yöneticilerin listesi
    vector<IObserver*> observers;

public:
    // Constructor (Sadece isim alýyor, ID 0 baþlýyor)
    ...
    // REQ8.5: Prototype Pattern
    virtual Device* clone() const = 0;

    // Cihaza özgü iþlem (Operate) - YENÝ EKLENDÝ
